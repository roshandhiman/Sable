...
export default function ConstellationGrid() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden select-none bg-slate-950 dark:bg-slate-950 light:bg-slate-50">
            ...
            <div className="relative z-10 flex h-full flex-col items-center justify-center -translate-y-10 md:-translate-y-16 text-center px-4 pointer-events-none mix-blend-difference text-white">
                <h1 className="font-mono text-7xl sm:text-9xl md:text-[15vw] font-black tracking-tighter uppercase leading-none">
                    SABLE
                </h1>
                <p className="mt-6 font-mono text-sm md:text-base max-w-xl opacity-75 tracking-wider">
